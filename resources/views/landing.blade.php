...
<main>
    <div class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 75vh;">
        <div class="absolute top-0 w-full h-full bg-center bg-cover" style='background-image: url("/storage/images/banner.jpeg");'>
                ...
                <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                    <div class="pr-12">
                        ...
                        <p class="mt-4 text-lg text-gray-300">
                            Solusi undangan hemat, praktis, dan kekinian dengan Undangan Online dengan budget yang ramah di kantong.
                        </p>
                    </div>
                </div>
            </div>
